...
public class ScoreBoard extends Applet implements Runnable, ActionListener {
	...
	System.out.println("See the file gpl.txt for details.");
        ...
        getParamTags();
        setupControlPanel();
        scoreboardImage = createImage(800,355);
        scoreboardGraphics = scoreboardImage.getGraphics();
        scoreboardImageCanvas = new ImageCanvas(scoreboardImage,this,800,355);
        ...
        if (slideShowDir != null) {
            scoreboardSlides = new SlideShow(this,getCodeBase(),slideShowDir,numSlides,slideDelay,800,245);
    ...
    public void resetScoreboard() {
        ...
        scoreboardGraphics.fillRect(0,0,800,355);
    ...
    public synchronized void paintTimer() {
      ...
      if (scoreboardMode == 1) {
        ...
        scoreboardGraphics.fillRoundRect(225,10,350,155,20,20);
        scoreboardImageCanvas.repaint(225,10,350,155);
      } else {
        ...
        if (dMin > 0) {
          if (dMil == 0) {
            ...
            scoreboardGraphics.drawString(sTim, 237, 135);
            scoreboardImageCanvas.repaint(225,10,350,155);
          }
        }
        else {
          ...
          scoreboardGraphics.drawString(sTim, 250, 135);
          scoreboardImageCanvas.repaint(225,10,350,155);
        }
      }
    }
	...
	if (scoreboardMode == 1) {
        ...
        scoreboardGraphics.fillRoundRect(225,175,350,50,10,10);
        scoreboardGraphics.setColor(textColor);
        scoreboardGraphics.drawString(periodString, lrPos, 215);
        scoreboardImageCanvas.repaint(225,175,350,50);
    }
    ...
    public synchronized void paintBonus() { 
        ...
        scoreboardGraphics.fillRoundRect(225,295,350,50,10,10);
	    ...
	    sTim = dMin + ":" + sSec;
	    scoreboardGraphics.setColor(textColor);
	    scoreboardGraphics.drawString("TIMEOUT", 275, 332);
	    scoreboardGraphics.drawString(sTim, 450, 332);
		...
		scoreboardGraphics.drawString(sTim, 450, 332);
                ...
                scoreboardGraphics.setColor(textColor);
                scoreboardGraphics.drawString("BONUS", 338, 332);
                scoreboardGraphics.setColor(bonusLightColor);
                if (homeInBonus == true) {
                    scoreboardGraphics.fillOval(235,305,30,30);
                }
                if (guestInBonus == true) {
                    scoreboardGraphics.fillOval(535,305,30,30);
                }
	    }
	}
        scoreboardImageCanvas.repaint(225,295,350,50);
    }
    ...
    public synchronized void paintHomeName() {
        ...
        scoreboardGraphics.setColor(bgColor);
        scoreboardGraphics.fillRoundRect(10,10,200,55,10,10);
        ...
        scoreboardGraphics.drawString(nameHome,
				      (110-(nameWidth/2)), (33+(fontSize/2)));
        scoreboardImageCanvas.repaint(10,10,200,55);
    }
    ...
    public synchronized void paintGuestName() { 
        ...
        scoreboardGraphics.setColor(bgColor);
        scoreboardGraphics.fillRoundRect(590,10,200,55,10,10);
        scoreboardGraphics.setColor(scoreColor);
        do {
            scoreboardGraphics.setFont(new Font(preferredFont, Font.PLAIN, fontSize));
            fontInfo = scoreboardGraphics.getFontMetrics();
        ...
        scoreboardGraphics.drawString(nameGuest,
				      (690-(nameWidth/2)), (33+(fontSize/2)));
        scoreboardImageCanvas.repaint(590,10,200,55);
    }
	...
	FontMetrics fontInfo;
        ...
        scoreboardGraphics.setColor(bgColor);
        scoreboardGraphics.fillRoundRect(10,75,200,150,10,10);
        scoreboardGraphics.setFont(new Font(preferredFont, Font.PLAIN, scoreFontSize));
        scoreboardGraphics.setColor(scoreColor);
	fontInfo = scoreboardGraphics.getFontMetrics();
	scoreWidth = fontInfo.stringWidth(score);
        scoreboardGraphics.drawString(score, (110 - (scoreWidth/2)), 190);
        scoreboardImageCanvas.repaint(10,75,200,150);
    }
	...
	FontMetrics fontInfo;
        ...
        scoreboardGraphics.setColor(bgColor);
        scoreboardGraphics.fillRoundRect(590,75,200,150,10,10);
        scoreboardGraphics.setFont(new Font(preferredFont, Font.PLAIN, scoreFontSize));
        scoreboardGraphics.setColor(scoreColor);
	fontInfo = scoreboardGraphics.getFontMetrics();
	scoreWidth = fontInfo.stringWidth(score);
        scoreboardGraphics.drawString(score, (690 - (scoreWidth/2)), 190);
        scoreboardImageCanvas.repaint(590,75,200,150);
    }
    ...
    public synchronized void paintPossesionArrow() {
        ...
        scoreboardGraphics.fillRoundRect(225,235,350,50,10,10);
        scoreboardGraphics.setColor(textColor);
        if (scoreboardMode == 1) {
            scoreboardGraphics.drawString("SERVING", 323, 272);
	} else {
            scoreboardGraphics.drawString("POSSESSION", 288, 272);
	}
        scoreboardGraphics.setColor(possesionArrowColor);
        if (possesionArrow == true) {
            scoreboardGraphics.fillOval(235,245,30,30);
        } else {
            scoreboardGraphics.fillOval(535,245,30,30);
        }
        scoreboardImageCanvas.repaint(225,235,350,50);
    }
    ...
    if (scoreboardMode == 1) {
        scoreboardGraphics.setColor(bgColor);
        scoreboardGraphics.fillRoundRect(10,235,200,50,10,10);
        scoreboardGraphics.fillRoundRect(590,295,200,50,10,10);
        scoreboardGraphics.fillRoundRect(10,295,200,50,10,10);
        scoreboardGraphics.fillRoundRect(590,235,200,50,10,10);
...
//   System.out.println(" lastGuestPlayer is -" + lastGuestPlayer + "-");
	if (lastGuestPlayer != null && lastGuestPlayer.length() > 0) {
        ...
        if ((totalHomeFouls+totalGuestFouls) > 0) {
            scoreboardGraphics.setFont(new Font(preferredFont, Font.PLAIN, 35));
            scoreboardGraphics.setColor(textColor);
            scoreboardGraphics.drawString(homeFouls, 20, 275);
            scoreboardGraphics.drawString(guestFouls, 600, 275);
            if (lastHomePlayer != null && totalHomeFouls > 0)
                    scoreboardGraphics.drawString(lastHome, 20, 335);
            if (lastGuestPlayer != null && totalGuestFouls > 0)
                scoreboardGraphics.drawString(lastGuest, 600, 335);
        }
        scoreboardImageCanvas.repaint(10,235,200,50);
        scoreboardImageCanvas.repaint(10,295,200,50);
        scoreboardImageCanvas.repaint(590,235,200,50);
