...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	while($row = $result->fetch_assoc()) {
		...
		echo ("<tr><td><span class='upcoming-title'>".$row["title"]."</span><span class='upcoming-date'>".$date."</span><span class='upcoming-description'>Description: ".$row["description"]."</span></td></tr>");
		}
	} else {
